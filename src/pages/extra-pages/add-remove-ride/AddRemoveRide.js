...
import AddRemoveRideHook from './addRemoveRideHook';

const UpdateUserRide = () => {
  const {duration,handleAddRide, handleUserIdChange,handleDurationChange, handleButtonClick,
   rideId,userId, filter,show,rideOption,handleSelectChange ,handleRemoveRide} = AddRemoveRideHook();
  const column = [
    {
      name: "User Id",
      // selector: id,
    ...
    },
    {
      ...
      cell: row => {
        ...
        return (
          <select value={rideId} onChange={e => handleSelectChange(e, userId)} className='frameSelect'>
