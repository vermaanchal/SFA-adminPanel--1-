...
const AgencyReceivingReport = () => {
    ...
    const fetchData = async () => {
        try {
            let req = await fetch(`${baseURLProd}AgencyReport`, {
                method: "GET",
                headers: {
            ...
            if (res.status == true) {
                setData(res.agencyReportList);
                setFilter(res.agencyReportList);
            }
            else {
    ...
    return (
        ...
        <MainCard title="Agency Receiving Report">
...
export default AgencyReceivingReport;
